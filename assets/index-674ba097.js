 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dc=new wg("@firebase/auth");function MN(t,...e){dc.logLevel<=Ce.WARN&&dc.warn(`Auth (${is}): ${t}`,...e)}function xu(t,...e){dc.logLevel<=Ce.ERROR&&dc.error(`Auth (${is}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bn{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=bn.makeFromUrl(e,n)}catch{return new bn(e,"")}if(r.path==="")return r;throw rL(e)}static makeFromUrl(e,n){let r=null;const i="([A-Za-z0-9.\\-_]+)";function s(E){E.path.charAt(E.path.length-1)==="/"&&(E.path_=E.path_.slice(0,-1))}const o="(/(.*))?$",a=new RegExp("^gs://"+i+o,"i"),l={bucket:1,path:3};function u(E){E.path_=decodeURIComponent(E.path)}const c="v[A-Za-z0-9_]+",d=n.replace(/[.]/g,"\\."),h="(/([^?#]*).*)?$",m=new RegExp(`^https?://${d}/${c}/b/${i}/o${h}`,"i"),_={bucket:1,path:3},v=n===_I?"(?:storage.googleapis.com|storage.cloud.google.com)":n,w="([^?#]*)",f=new RegExp(`^https?://${v}/${i}/${w}`,"i"),y=[{regex:a,indices:l,postModify:s},{regex:m,indices:_,postModify:u},{regex:f,indices:{bucket:1,path:2},postModify:u}];for(let E=0;E<y.length;E++){const x=y[E],k=x.regex.exec(e);if(k){const b=k[x.indices.bucket];let O=k[x.indices.path];O||(O=""),r=new bn(b,O),x.postModify(r);break}}if(r==null)throw nL(e);return r}}class sL{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,I9=()=>{const[t,e]=I.useState([]),n=En(In),r=[],i=Rr(),[s,o]=I.useState(!1),[a,l]=I.useState();let u=new Date().getTime()/1e3;const c=m=>{l(m),o(!0)},d=()=>{o(!1)},h=async()=>{$S(ce(J,"goods"),m=>{e(m.docs.map(_=>({..._.data(),id:_.id})).sort((_,v)=>_.createTime.seconds>v.createTime.seconds?-1:1))})};return I.useEffect(()=>{h()},[]),t.map(m=>{r.includes(m.category)||r.push(m.category)}),r.sort(),g.jsxs(g.Fragment,{children:[g.jsx(v9,{children:r.map(m=>{let _=0;return g.jsxs(w9,{children:[g.jsx(_9,{children:m}),g.jsx(E9,{children:t.map((v,w)=>{if(v.category===m&&(_++,window.innerWidth>=2160&&_<=8||window.innerWidth>=1152&&_<=6||window.innerWidth<1152&&_<=4))return g.jsxs(Jy,{onClick:()=>c(v),style:{backgroundImage:`url(${typeof v.image=="string"?v.image:v.image[0]})`},children:[n.favoriteList&&n.favoriteList.map(f=>{if(f.name===v.name)return g.jsx(n0,{})}),u-v.createTime.seconds<259200&&g.jsx(t0,{children:"Новинка!"}),g.jsxs(Zy,{children:[g.jsx(e0,{children:v.name}),g.jsxs("p",{children:[v.price," грн."]})]})]},w)})}),g.jsx(x9,{onClick:()=>i("/search",{state:{category:m}}),children:"Побачити більше"})]})})}),s&&g.jsx(hh,{card:a,closeModal:d})]})},T9=R.div`
  display: flex;
  align-content: center;
  justify-content: center;
  flex-wrap: wrap;
